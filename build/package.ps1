...
<extensions><extension name="SpotifyConnect" version="0.1.0" target="baby"><file>SpotifyConnect/</file></extension></extensions>
'@
Set-Content (Join-Path $dist 'extensions.xml') $xml -NoNewline
$zip = Join-Path $dist 'SpotifyConnect-0.1.0.zip'
